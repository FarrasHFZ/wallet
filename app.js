...
function onReceiptSelected(event) {
  ...
  reader.onload = (e) => {
    pendingReceiptBase64 = e.target.result;
    showReceiptPreview(pendingReceiptBase64, 'receipt-preview-container', 'receipt-preview-img');
    showToast('Receipt captured ✓', 'success');
  };
